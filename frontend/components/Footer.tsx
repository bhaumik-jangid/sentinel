  ...
  return (
    <footer className="bg-gray-950 dark:bg-[#080A10] text-gray-400 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 pb-14 border-b border-gray-800/60 dark:border-[#1A1D27]">

          {/* Brand */}
          <div className="md:col-span-1">
            <h3
              className="text-white dark:text-indigo-400 text-xl font-bold mb-4"
            ...
            <div className="flex gap-3 mt-5">
              {[Linkedin, Instagram, Youtube].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="p-2 rounded-xl border border-gray-800 dark:border-[#2A2D3E] text-gray-500 dark:text-slate-500 hover:text-indigo-400 hover:border-indigo-800 dark:hover:border-indigo-700 transition-all duration-200"
                >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-gray-500 dark:text-slate-500">
              {["Q&A Posting", "Image Sharing", "Community Moderation", "Privacy Controls", "Trending Topics"].map((s) => (
                <li key={s} className="hover:text-indigo-400 cursor-pointer transition-colors duration-200">{s}</li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500 dark:text-slate-500">
              <li className="flex items-start gap-2.5">
                <MapPin size={14} strokeWidth={1.6} className="mt-0.5 shrink-0 text-indigo-400" />
                Punjab, India
              </li>
              <li className="flex items-center gap-2.5">
                <Phone size={14} strokeWidth={1.6} className="shrink-0 text-indigo-400" />
                +91 75239 20202
              </li>
              <li className="flex items-center gap-2.5">
                <Mail size={14} strokeWidth={1.6} className="shrink-0 text-indigo-400" />
                info@Sentinel.com
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 dark:text-slate-600">
          ...
          <div className="flex gap-6 mt-3 md:mt-0">
            <span className="hover:text-indigo-400 cursor-pointer transition-colors duration-200">Privacy Policy</span>
            <span className="hover:text-indigo-400 cursor-pointer transition-colors duration-200">Terms</span>
          </div>
        </div>
      </div>
    </footer>
